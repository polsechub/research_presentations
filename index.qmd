...
$$ \Delta Y_{it} = \beta\Delta Piracy_{it}+\Delta U_{it} $$
Where, $i$ is for grid-cell and $t$ is month, and  $\Delta Y_{it}$ is the change in vessel traffic in log form, as explained by $\Delta Piracy_{it}$
